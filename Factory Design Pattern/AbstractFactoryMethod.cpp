...
class BasicGarlicBread : public GarlicBread {
    public:
        void prepare() override {
            cout<<"Cooking Basic Garlic bread using some secret ingrediants"<<endl;
        }
};
...
class CheeseGarlicBread : public GarlicBread {
    public:
        void prepare() override {
            cout<<"Cooking Cheese Garlic bread using some secret ingrediants"<<endl;
        }
};
...
class BasicWheatGarlicBread : public GarlicBread {
    public:
        void prepare() override {
            cout<<"Cooking Basic Wheat Garlic bread using some secret ingrediants"<<endl;
        }
};
...
class CheeseWheatGarlicBread : public GarlicBread {
    public:
        void prepare() override {
            cout<<"Cooking Cheese Garlic bread using some secret ingrediants and wheat"<<endl;
        }
};
...
class BurgerFactory {
    public:
        ...
        virtual GarlicBread* cookGarlicBread(string type) = 0;
};
...
class SinghBurger: public BurgerFactory {
    ...
    GarlicBread* cookGarlicBread(string type) override {
        if(type=="basic")
            return new BasicGarlicBread;
        else if(type=="cheese")
            return new CheeseGarlicBread;
        else
            cout<<"Invalid type of garlic bread"<<endl;
            return nullptr;
    }
...
int main(){
    ...
    GarlicBread* myGarlicBread = myfactory->cookGarlicBread(GarlicBreadType);
    myBurger->prepare();
